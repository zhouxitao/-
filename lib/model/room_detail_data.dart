...
class RoomDetailData {
  ...
  RoomDetailData({this.id, this.title, this.community, this.subTitle, this.size, this.floor, this.price, this.roomType, this.houseImgs, this.tags, this.oriented, this.applicances});
