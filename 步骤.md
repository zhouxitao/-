...
//  fromData.add("file",
//      files.map((file) => UploadFileInfo(file, 'picture.jpg')).toList());//此方法已废弃
...
// [File: '/Users/zhouxitao/Library/Developer/CoreSimulator/Devices/A42CF09A-DA4D-43D8-9DBA-2D8BC2B19291/data/Containers/Data/Application/116CEBA1-C20C-44C2-8967-07CF766A6EB6/tmp/image_picker_3FBB7091-EEA4-4943-9867-69DBB34548C0-81027-00002EB72D2DE2B8.jpg', File: '/Users/zhouxitao/Library/Developer/CoreSimulator/Devices/A42CF09A-DA4D-43D8-9DBA-2D8BC2B19291/data/Containers/Data/Application/116CEBA1-C20C-44C2-8967-07CF766A6EB6/tmp/image_picker_0A1ABA6F-B5F6-4330-A48D-78C01968119C-81027-00002EBA1956BEC5.jpg']
// 这是files 文件内容，需要通过files[i].path,取到每一项
...
4. 报错处理
   ...
   1. 重新登录的时候，报错
      ...
      ![image-20201216092208290](/Users/zhouxitao/Library/Application Support/typora-user-images/image-20201216092208290.png)

处理方法：在scope_model，里面的auth.dart，添加 if(data!=null)_userInfo = UserInfo.fromJson(data);//做报错处理
...
2. 修改图标及背景图
   ...
   文件地址：`静态资源/package/ios/Assets.xcassets`
